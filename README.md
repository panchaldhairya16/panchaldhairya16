...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=3DABF5&center=true&vCenter=true&random=false&width=520&lines=DevOps+Engineer;Cloud+%26+Infrastructure+Automation;AWS+%7C+Azure+%7C+Terraform+%7C+Kubernetes)](https://git.io/typing-svg)
...
- CI/CD & Automation: GitHub Actions, Azure Pipelines, Ansible
- Containers & Orchestration: Docker, Kubernetes
- Observability: Prometheus, Grafana, ELK stack
- Scripting & OS: Bash, PowerShell, Python, Linux (Ubuntu/CentOS)

## What I build

- Reproducible cloud environments (VPC, networking, IAM, storage, compute)
- Automated CI/CD pipelines for tests, builds, and infra/app deployments
- Containerized microservices and Kubernetes clusters with monitoring and alerting
...
[![GitHub Streak](https://github-readme-streak-stats.herokuapp.com?user=dhairyapanchal16&theme=transparent&hide_border=true&card_width=600)](https://git.io/streak-stats)
